      ...
      <div style={{background:"#fff",borderRadius:20,padding:"28px 24px",maxWidth:360,width:"100%",textAlign:"center",boxShadow:"0 8px 40px rgba(0,0,0,.3)"}}>
        ...
        {mode==="login"&&<>
          ...
          <button onClick={()=>{setMode("reset");setErr("");}}
            style={{background:"none",border:"none",color:TX3,fontSize:".74rem",cursor:"pointer",fontFamily:"inherit"}}>
            パスワードを忘れた方
          </button>
        </>}
        {mode==="reset"&&<>
          <div style={{textAlign:"left",marginBottom:12}}>
            <div style={{fontSize:".78rem",color:TX3,marginBottom:12}}>登録メールにリセット用リンクを送ります</div>
            <div style={{fontSize:".74rem",fontWeight:700,color:"#5c3d1e",marginBottom:3}}>メールアドレス</div>
          ...
          {err&&<div style={{color:err.includes("送信しました")?"#2d6a3f":"#e74c3c",fontSize:".78rem",marginTop:4,marginBottom:8}}>{err}</div>}
